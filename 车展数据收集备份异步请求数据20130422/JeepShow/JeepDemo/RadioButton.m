...
static const NSUInteger kRadioButtonWidth=282;
...
-(void)defaultInit{
   ...
   _button.adjustsImageWhenHighlighted = NO; 
    ...
    [_button setTitle:_settitle forState:UIControlStateNormal];
    _button.titleLabel.font=[UIFont fontWithName:@"Helvetica" size:16];
