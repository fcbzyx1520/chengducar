...
- (void)updateData {
    ...
    NSRange range=[_searchText rangeOfString:@"@"];
    NSString *searchText=_searchText;
    if(range.length>=1)
    {
        searchText=[_searchText substringToIndex:range.location];
    }
    
    [_resultList addObject:[NSString stringWithFormat:@"%@@gmail.com",searchText]];
    [_resultList addObject:[NSString stringWithFormat:@"%@@163.com",searchText]];
    [_resultList addObject:[NSString stringWithFormat:@"%@@qq.com",searchText]];
    [_resultList addObject:[NSString stringWithFormat:@"%@@126.com",searchText]];
    [_resultList addObject:[NSString stringWithFormat:@"%@@sina.com",searchText]];
